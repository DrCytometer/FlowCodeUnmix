...
- thresholds:
  ...
  Optional named numeric vector of positivity thresholds for the
  FlowCode fluorophores. Overrides the thresholds provided by
  `flowcode.spectra`. Default is `NULL`, which is unused.
