...
* Where are the cells (user-drawn gate)?
...
This saves the output as an RDS file in the folder specified by `output.dir`. If you change `output.dir`, you'll need to change it later in `get.flowcode.spectra()`.
...
Note: I haven't written this yet.
